...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="space-y-3">
            <a href="items.php?action=add" class="flex items-center p-3 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors">
            ...
            <a href="loans.php?action=add" class="flex items-center p-3 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors">
                <i class="fas fa-hand-holding text-amber-600 mr-3"></i>
                <div>
            ...
            <a href="returns.php?action=add" class="flex items-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors">
                <i class="fas fa-undo text-emerald-600 mr-3"></i>
                <div>
...
<div class="space-y-6">
    ...
    <div class="bg-rose-50 border border-rose-200 rounded-lg p-4">
        <div class="flex items-start">
            <i class="fas fa-exclamation-circle text-rose-600 mt-1 mr-3"></i>
            <div class="flex-1">
